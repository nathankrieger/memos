...
export const WorkspaceSetting: MessageFns<WorkspaceSetting> = {
  ...
  fromJSON(object: any): WorkspaceSetting {
    return {
      ...
      generalSetting: isSet(object.generalSetting)
        ? WorkspaceGeneralSetting.fromJSON(object.generalSetting)
        : undefined,
      storageSetting: isSet(object.storageSetting)
        ? WorkspaceStorageSetting.fromJSON(object.storageSetting)
        : undefined,
      memoRelatedSetting: isSet(object.memoRelatedSetting)
        ? WorkspaceMemoRelatedSetting.fromJSON(object.memoRelatedSetting)
        : undefined,
    };
  },
  ...
  toJSON(message: WorkspaceSetting): unknown {
    ...
    if (message.generalSetting !== undefined) {
      obj.generalSetting = WorkspaceGeneralSetting.toJSON(message.generalSetting);
    }
    if (message.storageSetting !== undefined) {
      obj.storageSetting = WorkspaceStorageSetting.toJSON(message.storageSetting);
    }
    if (message.memoRelatedSetting !== undefined) {
      obj.memoRelatedSetting = WorkspaceMemoRelatedSetting.toJSON(message.memoRelatedSetting);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<WorkspaceSetting>, I>>(base?: I): WorkspaceSetting {
    return WorkspaceSetting.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<WorkspaceSetting>, I>>(object: I): WorkspaceSetting {
    const message = createBaseWorkspaceSetting();
...
export const WorkspaceGeneralSetting: MessageFns<WorkspaceGeneralSetting> = {
  ...
  create<I extends Exact<DeepPartial<WorkspaceGeneralSetting>, I>>(base?: I): WorkspaceGeneralSetting {
    return WorkspaceGeneralSetting.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<WorkspaceGeneralSetting>, I>>(object: I): WorkspaceGeneralSetting {
    const message = createBaseWorkspaceGeneralSetting();
...
export const WorkspaceCustomProfile: MessageFns<WorkspaceCustomProfile> = {
  ...
  create<I extends Exact<DeepPartial<WorkspaceCustomProfile>, I>>(base?: I): WorkspaceCustomProfile {
    return WorkspaceCustomProfile.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<WorkspaceCustomProfile>, I>>(object: I): WorkspaceCustomProfile {
    const message = createBaseWorkspaceCustomProfile();
...
function createBaseWorkspaceStorageSetting(): WorkspaceStorageSetting {
  return { storageType: 0, filepathTemplate: "", uploadSizeLimitMb: "0", s3Config: undefined };
}
...
export const WorkspaceStorageSetting: MessageFns<WorkspaceStorageSetting> = {
  encode(message: WorkspaceStorageSetting, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.storageType !== 0) {
      writer.uint32(8).int32(message.storageType);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.uploadSizeLimitMb = reader.int64().toString();
          continue;
        }
        case 4: {
          if (tag !== 34) {
  ...
  fromJSON(object: any): WorkspaceStorageSetting {
    return {
      storageType: isSet(object.storageType) ? workspaceStorageSetting_StorageTypeFromJSON(object.storageType) : 0,
      filepathTemplate: isSet(object.filepathTemplate) ? globalThis.String(object.filepathTemplate) : "",
      uploadSizeLimitMb: isSet(object.uploadSizeLimitMb) ? globalThis.String(object.uploadSizeLimitMb) : "0",
  ...
  toJSON(message: WorkspaceStorageSetting): unknown {
    ...
    if (message.uploadSizeLimitMb !== "0") {
      obj.uploadSizeLimitMb = message.uploadSizeLimitMb;
    }
    if (message.s3Config !== undefined) {
  ...
  create<I extends Exact<DeepPartial<WorkspaceStorageSetting>, I>>(base?: I): WorkspaceStorageSetting {
    return WorkspaceStorageSetting.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<WorkspaceStorageSetting>, I>>(object: I): WorkspaceStorageSetting {
    const message = createBaseWorkspaceStorageSetting();
...
export const WorkspaceStorageSetting_S3Config: MessageFns<WorkspaceStorageSetting_S3Config> = {
  ...
  fromJSON(object: any): WorkspaceStorageSetting_S3Config {
    return {
      ...
      usePathStyle: isSet(object.usePathStyle) ? globalThis.Boolean(object.usePathStyle) : false,
    };
  },
  ...
  toJSON(message: WorkspaceStorageSetting_S3Config): unknown {
    ...
    if (message.usePathStyle !== false) {
      obj.usePathStyle = message.usePathStyle;
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<WorkspaceStorageSetting_S3Config>, I>>(
    base?: I,
  ): WorkspaceStorageSetting_S3Config {
    return WorkspaceStorageSetting_S3Config.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<WorkspaceStorageSetting_S3Config>, I>>(
    object: I,
  ): WorkspaceStorageSetting_S3Config {
    const message = createBaseWorkspaceStorageSetting_S3Config();
...
export const WorkspaceMemoRelatedSetting: MessageFns<WorkspaceMemoRelatedSetting> = {
  ...
  fromJSON(object: any): WorkspaceMemoRelatedSetting {
    return {
      ...
      disableMarkdownShortcuts: isSet(object.disableMarkdownShortcuts)
        ...
        : false,
      enableBlurNsfwContent: isSet(object.enableBlurNsfwContent)
        ? globalThis.Boolean(object.enableBlurNsfwContent)
        : false,
      nsfwTags: globalThis.Array.isArray(object?.nsfwTags)
        ? object.nsfwTags.map((e: any) => globalThis.String(e))
        : [],
    };
  },
  ...
  toJSON(message: WorkspaceMemoRelatedSetting): unknown {
    ...
    if (message.enableBlurNsfwContent !== false) {
      obj.enableBlurNsfwContent = message.enableBlurNsfwContent;
    }
    if (message.nsfwTags?.length) {
      obj.nsfwTags = message.nsfwTags;
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<WorkspaceMemoRelatedSetting>, I>>(base?: I): WorkspaceMemoRelatedSetting {
    return WorkspaceMemoRelatedSetting.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<WorkspaceMemoRelatedSetting>, I>>(object: I): WorkspaceMemoRelatedSetting {
    const message = createBaseWorkspaceMemoRelatedSetting();
...
export const GetWorkspaceSettingRequest: MessageFns<GetWorkspaceSettingRequest> = {
  ...
  create<I extends Exact<DeepPartial<GetWorkspaceSettingRequest>, I>>(base?: I): GetWorkspaceSettingRequest {
    return GetWorkspaceSettingRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetWorkspaceSettingRequest>, I>>(object: I): GetWorkspaceSettingRequest {
    const message = createBaseGetWorkspaceSettingRequest();
    message.name = object.name ?? "";
    return message;
  },
...
export const SetWorkspaceSettingRequest: MessageFns<SetWorkspaceSettingRequest> = {
  ...
  create<I extends Exact<DeepPartial<SetWorkspaceSettingRequest>, I>>(base?: I): SetWorkspaceSettingRequest {
    return SetWorkspaceSettingRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SetWorkspaceSettingRequest>, I>>(object: I): SetWorkspaceSettingRequest {
    const message = createBaseSetWorkspaceSettingRequest();
...
export interface WorkspaceSettingService {
  /** GetWorkspaceSetting returns the setting by name. */
  GetWorkspaceSetting(request: GetWorkspaceSettingRequest): Promise<WorkspaceSetting>;
  /** SetWorkspaceSetting updates the setting. */
  SetWorkspaceSetting(request: SetWorkspaceSettingRequest): Promise<WorkspaceSetting>;
}

export const WorkspaceSettingServiceServiceName = "memos.api.v1.WorkspaceSettingService";
export class WorkspaceSettingServiceClientImpl implements WorkspaceSettingService {
  private readonly rpc: Rpc;
  private readonly service: string;
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || WorkspaceSettingServiceServiceName;
    this.rpc = rpc;
    this.GetWorkspaceSetting = this.GetWorkspaceSetting.bind(this);
    this.SetWorkspaceSetting = this.SetWorkspaceSetting.bind(this);
  }
  GetWorkspaceSetting(request: GetWorkspaceSettingRequest): Promise<WorkspaceSetting> {
    const data = GetWorkspaceSettingRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetWorkspaceSetting", data);
    return promise.then((data) => WorkspaceSetting.decode(new BinaryReader(data)));
  }

  SetWorkspaceSetting(request: SetWorkspaceSettingRequest): Promise<WorkspaceSetting> {
    const data = SetWorkspaceSettingRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "SetWorkspaceSetting", data);
    return promise.then((data) => WorkspaceSetting.decode(new BinaryReader(data)));
  }
}
